...
// Handler: donut.js script
logger.debug('Handler: donut.js script');
logger.debug('Serving from base path "' + handlerPathPrefix + '/static"');
app.get(handlerPathPrefix + '/static/donut.js', function (req, res) {
  res.sendFile(__dirname + '/static/donut.js');
});
